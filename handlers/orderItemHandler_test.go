...
func TestSix910Handler_AddOrderItem(t *testing.T) {
	...
	h := sh.GetNew()
	aJSON := io.NopCloser(bytes.NewBufferString(`{"orderItem": {"quantity": 4, "orderId": 3 }, "storeId": 5}`))
...
func TestSix910Handler_AddOrderItem2(t *testing.T) {
	var sdb sixmdb.MockSix910Mysql
	var l lg.Logger
	l.LogLevel = lg.AllLevel
	sdb.Log = &l
...
func TestSix910Handler_UpdateOrderItem(t *testing.T) {
	...
	h := sh.GetNew()
	aJSON := io.NopCloser(bytes.NewBufferString(`{"orderItem": {"id": 3, "quantity": 4, "orderId": 3 }, "storeId": 5}`))
	//aJSON, _ := json.Marshal(robj)
	//fmt.Println("aJSON: ", aJSON)
...
func TestSix910Handler_GetOrderItemList2(t *testing.T) {
	var sdb sixmdb.MockSix910Mysql
	var l lg.Logger
	l.LogLevel = lg.AllLevel
	sdb.Log = &l
