...
-- Wed 14 Apr 2022 10:28:20 AM EDT
...
CREATE TABLE IF NOT EXISTS `six910`.`store` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `oauth_client_id_UNIQUE` (`oauth_client_id` ASC) VISIBLE,
  UNIQUE INDEX `store_name_UNIQUE` (`store_name` ASC) VISIBLE,
  UNIQUE INDEX `local_domain_UNIQUE` (`local_domain` ASC) VISIBLE,
  UNIQUE INDEX `remote_domain_UNIQUE` (`remote_domain` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `six910`.`customer` (
  ...
  `date_updated` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_customer_cart_owner_idx` (`store_id` ASC) VISIBLE,
  INDEX `index3` (`email` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`address` (
  ...
  `attr1` VARCHAR(150) NULL,
  `arrt2` VARCHAR(150) NULL,
  `attr3` VARCHAR(150) NULL,
  `attr4` VARCHAR(150) NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `six910`.`distributor` (
  ...
  `store_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_distributor_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`category` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_category_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`product` (
  ...
  `date_updated` DATETIME NULL,
  `has_sub_skus` TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  INDEX `fk_product_distributor1_idx` (`distributor_id` ASC) VISIBLE,
  INDEX `fk_product_store1_idx` (`store_id` ASC) VISIBLE,
  INDEX `index4` (`sku` ASC, `name` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`orders` (
  ...
  `refunded` DECIMAL(15,2) NULL DEFAULT 0,
  `ffl_name` VARCHAR(150) NULL,
  `ffl_lic` VARCHAR(150) NULL,
  `ffl_exp_date` VARCHAR(100) NULL,
  `ffl_phone` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `six910`.`shipment_box` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_shipment_box_shipment1_idx` (`shipment_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`shipment_item` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_shipment_item_order_item1_idx` (`order_item_id` ASC) VISIBLE,
  INDEX `fk_shipment_item_shipment1_idx` (`shipment_id` ASC) VISIBLE,
  INDEX `fk_shipment_item_shipment_box1_idx` (`shipment_box_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`shipping_carrier` (
  ...
  `store_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_shipping_method_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`region` (
  ...
  `store_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_region_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`shipping_method` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_shipping_store1_idx` (`store_id` ASC) VISIBLE,
  INDEX `fk_shipping_method_region1_idx` (`region_id` ASC) VISIBLE,
  INDEX `fk_shipping_method_shipping_carrier1_idx` (`shipping_carrier_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`cart` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_cart_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`local_account` (
  ...
  INDEX `fk_local_accounts_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`store_plugins` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_plugins_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`sub_region` (
  ...
  `region_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_sub_region_region1_idx` (`region_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`excluded_sub_region` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_excluded_sub_region_region1_idx` (`region_id` ASC) VISIBLE,
  INDEX `fk_excluded_sub_region_shipping_method1_idx` (`shipping_method_id` ASC) VISIBLE,
  INDEX `fk_excluded_sub_region_sub_region1_idx` (`sub_region_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`insurance` (
  ...
  `store_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_insurance_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`included_sub_region` (
  ...
  `sub_region_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_included_sub_region_region1_idx` (`region_id` ASC) VISIBLE,
  INDEX `fk_included_sub_region_shipping_method1_idx` (`shipping_method_id` ASC) VISIBLE,
  INDEX `fk_included_sub_region_sub_region1_idx` (`sub_region_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`local_data_store` (
  ...
  INDEX `fk_local_data_store_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`instances` (
  ...
  `store_id` BIGINT NOT NULL,
  `data_store_name` VARCHAR(50) NOT NULL,
  INDEX `fk_instances_local_data_store1_idx` (`store_id` ASC, `data_store_name` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`datastore_write_lock` (
  ...
  INDEX `fk_datastore_lock_store1_idx` (`store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`order_transaction` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_order_transaction_order1_idx` (`order_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`payment_gateway` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_payment_gateway_store_plugins1_idx` (`store_plugins_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`order_comment` (
  ...
  `username` VARCHAR(50) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_order_comment_order1_idx` (`order_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `six910`.`tax_rate` (
  ...
  `percent_rate` FLOAT NOT NULL DEFAULT 0,
  ...
  INDEX `fk_tax_rate_store1_idx` (`store_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `six910`.`visitor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `six910`.`visitor` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  `store_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_visitor_store1_idx` (`store_id` ASC) VISIBLE,
  CONSTRAINT `fk_visitor_store1`
    FOREIGN KEY (`store_id`)
    REFERENCES `six910`.`store` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `six910`.`product_sub_sku`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `six910`.`product_sub_sku` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `product_id` BIGINT NOT NULL,
  `sub_sku` VARCHAR(45) NOT NULL,
  `stock` INT NOT NULL DEFAULT 0,
  `size` VARCHAR(45) NULL,
  `color` VARCHAR(45) NULL,
  `weight` FLOAT NOT NULL DEFAULT 0,
  ...
  `sale_price` DECIMAL(15,2) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  INDEX `fk_product_size_product1_idx` (`product_id` ASC) VISIBLE,
