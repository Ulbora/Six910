...
-- Fri 29 May 2020 01:32:09 PM EDT
...
CREATE TABLE IF NOT EXISTS `six910`.`category` (
  ...
  `parient_category_id` BIGINT NULL,
...
CREATE TABLE IF NOT EXISTS `six910`.`product` (
  ...
  `map` DECIMAL(15,2) NULL,
  `price` DECIMAL(15,2) NOT NULL DEFAULT 0,
  `sale_price` DECIMAL(15,2) NULL,
  `currency` VARCHAR(5) NOT NULL,
  `manufacturer` VARCHAR(45) NULL,
  `stock` INT NOT NULL DEFAULT 0,
  `stock_alert` INT NULL,
  `weight` FLOAT NOT NULL,
  `width` FLOAT NULL,
  `height` FLOAT NULL,
  `depth` FLOAT NULL,
  `shipping_markup` DECIMAL(15,2) NULL,
  `visible` TINYINT(1) NOT NULL DEFAULT 1,
  `searchable` TINYINT(1) NOT NULL DEFAULT 1,
  `multibox` TINYINT(1) NOT NULL DEFAULT 0,
  `ship_seperate` TINYINT(1) NOT NULL DEFAULT 0,
  ...
  `parient_product_id` BIGINT NULL,
  `store_id` BIGINT NOT NULL,
  `thumbnail` VARCHAR(150) NULL,
  ...
  `special_processing` TINYINT(1) NULL DEFAULT 0,
...
-- Table `six910`.`order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `six910`.`order` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `six910`.`shipment` (
  ...
  `status` VARCHAR(45) NOT NULL,
  `boxes` INT NULL DEFAULT 0,
  `shipping_handling` DECIMAL(15,2) NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `six910`.`shipment_box` (
  ...
  `dropshipped` TINYINT(1) NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `six910`.`local_account` (
  ...
  INDEX `fk_local_account_customer1_idx` (`customer_id` ASC),
  ...
  CONSTRAINT `fk_local_accounts_store1`
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_local_account_customer1`
    FOREIGN KEY (`customer_id`)
    REFERENCES `six910`.`customer` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `six910`.`instances` (
  ...
  `reload_date` DATETIME NOT NULL,
  `local_data_store_store_id` BIGINT NOT NULL,
  `local_data_store_data_store_name` VARCHAR(50) NOT NULL,
  INDEX `fk_instances_local_data_store1_idx` (`local_data_store_store_id` ASC, `local_data_store_data_store_name` ASC),
  PRIMARY KEY (`instance_name`, `local_data_store_store_id`, `local_data_store_data_store_name`),
  CONSTRAINT `fk_instances_local_data_store1`
    FOREIGN KEY (`local_data_store_store_id` , `local_data_store_data_store_name`)
...
CREATE TABLE IF NOT EXISTS `six910`.`zone_zip` (
  ...
  `included_sub_region_id` BIGINT NULL,
  `excluded_sub_region_id` BIGINT NULL,
  PRIMARY KEY (`id`),
