...
var doc = `{
    ...
    "paths": {
        ...
        "/rs/category/get/list/hierarchical/{storeId}": {
            "get": {
        ...
        "/rs/get/customer/users/{cid}/{storeId}": {
            "get": {
        ...
        "/rs/order/get/store/list/status/{status}/{storeId}": {
            "get": {
                "description": "Get list of order for a store",
                "consumes": [
                    "application/json"
        ...
        "/rs/order/get/store/list/{storeId}": {
            "get": {
                "description": "Get list of order for a store",
                "consumes": [
                    "application/json"
        ...
        "/rs/product/get/sku/{sku}/{did}/{storeId}": {
            "get": {
                "description": "Get details of a product",
                "consumes": [
                    "application/json"
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "product distributor id",
                        "name": "did",
                        "in": "path",
                        "required": true
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/six910-database-interface.TaxRate"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/rs/taxRate/get/country/{country}/{state}/{storeId}": {
            "get": {
    ...
    "definitions": {
        ...
        "six910-database-interface.TaxRate": {
            "type": "object",
            "properties": {
                "country": {
                    "type": "string"
